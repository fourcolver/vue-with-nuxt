    ...
    <div v-if="!closed" class="fullscreen-v-img" @click.self="close">
      ...
      <div class="header-v-img">
        ...
        <div class="buttons-v-img">
          ...
          <span class="e-download" @click="download(images[currentImageIndex])">
            <i class="bu-down"></i>
          </span>
          <span @click="close">
            &times;
      ...
      <div class="content-v-img">
        <img :src="images[currentImageIndex]" @click="close">
      </div>
...
<script>
  export default {
    ...
    methods: {
      ...
      download (img) {
        window.location.href = img + (img.indexOf('?') === '-1' ? '?' : '&') + 'download=1'
      }
    },
    created () {
      ...
      window.addEventListener('click', () => this.showUI())
      window.addEventListener('keyup', () => this.showUI())
    }
  }
</script>
